...
x10 -nocompressedrefs -v -J"-Xmx$MAXHEAP" -J"-Xms$MINHEAP" -J"-Xss$STACK" -J"-Dxasdi.location.bootxml=$XMLFILE" -J"-Dadaptive=false"  -classpath "${PWD}${FILE_SEP}..${FILE_SEP}jar${FILE_SEP}xasdi.jar${PATH_SEP}${PWD}${FILE_SEP}mysample2.jar" $PROGRAM
